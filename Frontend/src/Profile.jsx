...
function Profile() {
  ...
  return (
    <>
      <div className="min-h-screen pb-20  bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-6 md:mb-12">
              <div className="inline-flex items-center gap-3  md:mb-4">
                ...
                <h1 className="text-3xl md:text-2xl font-bold bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
                  Edit Profile
                </h1>
              </div>
