          ...
          >
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex  gap-2">
              <button
                ...
                className="text-sm sm:text-[15px] border py-1.5 px-5 rounded-2xl text-green-400 border-green-400 hover:bg-green-700 hover:text-white transition"
              >
                Accept
              </button>
              <button
                onClick={() => rejectRequest(profile.uniqueId)}
                className="text-sm sm:text-[15px] border py-1.5 px-5 rounded-2xl text-red-400 border-red-400 hover:bg-red-700 hover:text-white transition"
              >
                Reject
              </button>
            </div>
